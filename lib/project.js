  ...
  get application() {
    return merge({
      ...
      build: {
        ...
        patchjs: false, // Enable patchjs or not，the configs from https://github.com/patchjs/patchjs-webpack-plugin
        verifySemver: false // Enable semver validation or not
      },
